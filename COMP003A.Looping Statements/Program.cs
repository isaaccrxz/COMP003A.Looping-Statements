...
namespace COMP003A.Looping_Statements
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            /*
             * The  The for statement: executes its body while a specified Boolean expression evaluates to true.
             ...
             * each execution of the loop, a do loop executes one or more times. The do statment differes from a while loop, which executes zero or more times.
             */
             ...
             * Booleah expression evaluates to true. Because that expression is evaluated before
